...
test[25] := VerificationTest[(* #25 *)
  a == b * a // rewriteIt @@ List/@ReplaceAll/@{a -> d, b -> c}
  ,
  d == c * a
];
...
test[36] := VerificationTest[(* #36 *)
  x D[f[x, y], y] - y D[f[x, y], x] // changeVars[{x, y}, {r, phi}, {x -> r Cos[phi], y -> r Sin[phi]}] // Factor,
	D[f[r, phi], phi]
];
