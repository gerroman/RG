...
setTilde::usage = "setTilde[x] set symbol tilde`x in TraditionalForm to have tilde as overscript"
setPrime::usage = "setPrime[x] set symbol prime`x in TraditionalForm to have prime (') as superscript"
setBar::usage = "setBar[x] set symbol bar`x in the TraditionalForm to have overbar"
setHat::usage = "setHat[x] set symbol hat`x in the TraditionalForm to have overhat"
setVec::usage = "setVec[x] set symbol vec`x to be bold in the TraditionalForm"
setTilde::usage = "setTilde[x] set symbol tilde`x in the TraditionalForm to have overtilde"
