...
";
\[Omega]::usage = "
  \[Omega][plus](\[Omega][minus])  -- projector to right(left) bispinors
";
...
outer\[LetterSpace]dot::usage = "
  outer\[LetterSpace]dot[kinematic] -- evaluates products  u.bar`u and v.bar`v within kinematic
";
...
sigma[p_List /; (Length[p] == 4)] := 
  sp[Prepend[Array[PauliMatrix, 3], IdentityMatrix[2]], p];
bar\[LetterSpace]sigma[p_List /; (Length[p] == 4)] := 
  sp[Prepend[(-1) * Array[PauliMatrix, 3], IdentityMatrix[2]], p];
...
rule`bispinor\[LetterSpace]explicit = {
     ...
     bar`u[
     p_List /; (Length[p] == 4), xi_List /; (Length[xi] == 2)] :> Conjugate[
      u[p, xi] // 
       Replace[rule`bispinor\[LetterSpace]explicit]].(\[Gamma][0] // Replace[eq`gamma\[LetterSpace]standard])
     , bar`v[
     p_List /; (Length[p] == 4), eta_List /; (Length[eta] == 2)] :> Conjugate[
      v[p, eta] // 
       Replace[rule`bispinor\[LetterSpace]explicit]].(\[Gamma][0] // 
       Replace[eq`gamma\[LetterSpace]standard])
   };
  ...
  eq`z\[LetterSpace]kinematic = eq`z\[LetterSpace]kinematic~Join~(
     {
       ...
       ReplaceAll[eq`z\[LetterSpace]kinematic] /*
       Replace[rule`bispinor\[LetterSpace]explicit]
     ]
  );
...
Block[{$Assumptions = (
  ...
  eq`theta\[LetterSpace]phi\[LetterSpace]kinematic[] = 
   eq`theta\[LetterSpace]phi\[LetterSpace]kinematic[]~Join~(
     {
  ...
  eq`theta\[LetterSpace]phi\[LetterSpace]kinematic[] = eq`theta\[LetterSpace]phi\[LetterSpace]kinematic[]~Join~({
    ...
    ReplaceAll[eq`theta\[LetterSpace]phi\[LetterSpace]kinematic[]] /* 
  ...
  eq`theta\[LetterSpace]phi\[LetterSpace]kinematic[] = eq`theta\[LetterSpace]phi\[LetterSpace]kinematic[]~Join~({
    ...
    ReplaceAll[eq`theta\[LetterSpace]phi\[LetterSpace]kinematic[]] /* 
    Replace[rule`bispinor\[LetterSpace]explicit] /* Simplify
  ]);
  eq`theta\[LetterSpace]phi\[LetterSpace]kinematic[] = eq`theta\[LetterSpace]phi\[LetterSpace]kinematic[]~Join~({
...
outer\[LetterSpace]dot[kinematic_: eq`z\[LetterSpace]kinematic] := Function[
  {expr},
  expr // ReplaceAll[
  (Dot[a : (_u), b : (_bar`u)] | Dot[a : (_v), b : (_bar`v)]) :> 
  Outer[
    Times
    , a // ReplaceAll[kinematic]
    , b // ReplaceAll[kinematic]
  ]
]];
